...
SAMPLE_IMAGE_PATH = os.path.join(dirname, 'images', 'sample', '')
ANTI_SPOOF_MODEL_PATH = os.path.join(dirname, 'resources', 'anti_spoof_models', '')
